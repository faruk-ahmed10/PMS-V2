...
class MiscFund extends Model
{
    use HasFactory;
    use SoftDeletes;
    use HasFactory;

    protected $table = 'misc_funds';
    ...
    public function contractors() {
        return $this->belongsToMany(Contractor::class)->with('user');
    }
    ...
    public function parent_item(){
        return $this->hasOne(MiscFund::class, 'id', 'parent_item_id');
    }
}
