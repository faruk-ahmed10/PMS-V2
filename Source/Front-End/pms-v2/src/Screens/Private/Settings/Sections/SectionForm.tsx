...
class SectionForm extends React.Component<any, any> {
    public state: any;
    private readonly section_id: number;

    public constructor(props: any) {
        super(props);

        this.section_id = typeof props.match.params.id === 'undefined' ? 0 : Number(props.match.params.id);

        this.state = {
            NotFoundException: false,
            Name: '',

            EditMode: this.section_id > 0,
        };
    ...
    protected getSectionData(): void {
        new APP.SERVICES.SECTIONS().GetSection(this.section_id).then(({data}) => {
    ...
    protected handleSubmitSection(): void {
        new APP.SERVICES.SECTIONS().SaveUnit({
            ...
            <React.Fragment>
                <Card className={__css_card}>
                    <div className={__css_cardTitle}>
                        <div className={"title"}>
                            Section {this.state.EditMode ? "EDIT" : "CREATE"}
                            ...
                            <Row>
                                ...
                                <Col md={6} style={{textAlign: "left"}}>
                                    <button className={__css_SaveContractorBtn}
                                            onClick={this.handleSubmitSection}>Submit
                                    </button>
                                </Col>
                            </Row>
                        </Card.Text>
