...
class SectionList extends React.Component<any, any> {
    ...
    protected handleGetSection() {
        new APP.SERVICES.SECTIONS().GetSections({
            ...
            <React.Fragment>
                <div style={{marginTop: 15}}>
                    <Row>
                        <Col md={8}>
                            <h4>
                                <Link to={APP.ROUTES.PRIVATE.SECTIONS}>Section List</Link>
                            </h4>
                        </Col>
                        <Col md={4}>
                            <div style={{textAlign: "right"}}>
                                <Link to={APP.ROUTES.PRIVATE.CREATE_SECTION}>
                                    <button className={__css_CreateContractorBtn}>Create Section</button>
                                </Link>
                            </div>
                        </Col>
                    </Row>
