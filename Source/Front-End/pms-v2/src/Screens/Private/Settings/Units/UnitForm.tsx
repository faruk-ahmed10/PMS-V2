...
class UnitForm extends React.Component<any, any> {
    public state: any;
    ...
    public constructor(props: any) {
        ...
        this.unit_id = typeof props.match.params.id === 'undefined' ? 0 : Number(props.match.params.id);

        this.state = {
            NotFoundException: false,
            Name: '',

            EditMode: this.unit_id > 0,
        };
    ...
    protected getUnitData(): void {
        new APP.SERVICES.UNITS().GetUnit(this.unit_id).then(({data}) => {
    ...
    protected handleSubmitUnit(): void {
        new APP.SERVICES.UNITS().SaveUnit({
            ...
            <React.Fragment>
                <Card className={__css_card}>
                    <div className={__css_cardTitle}>
                        <div className={"title"}>
                            UNIT {this.state.EditMode ? "EDIT" : "CREATE"}
                            ...
                            <Row>
                                ...
                                <Col md={6} style={{textAlign: "left"}}>
                                    <button className={__css_SaveContractorBtn}
                                            onClick={this.handleSubmitUnit}>Submit
                                    </button>
                                </Col>
                            </Row>
                        </Card.Text>
