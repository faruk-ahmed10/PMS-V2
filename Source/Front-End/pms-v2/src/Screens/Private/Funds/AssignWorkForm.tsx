...
class AssignWorkForm extends React.Component<any, any> {
    public state: any;
    ...
    protected getParentTasks(): void {
        new APP.SERVICES.BILL().GetParentTasks(this.state.FundType,'',this.state.ProjectId).then(({data}) => {
            ...
            <React.Fragment>
                <Card className={__css_card}>
                    <div className={__css_cardTitle}>
                        <div className={"title"}>
                            Assign Work {this.state.EditMode ? "EDIT" : "CREATE"}
...
export default withRouter(AssignWorkForm);
