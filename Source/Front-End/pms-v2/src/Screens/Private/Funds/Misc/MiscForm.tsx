...
class MiscForm extends React.Component<any, any> {
    public state: any;
    private readonly misc_id: number;

    public constructor(props: any) {
        super(props);

        this.misc_id = typeof props.match.params.id === 'undefined' ? 0 : Number(props.match.params.id);
        ...
        this.state = {
            ...
            EditMode: this.misc_id > 0,
        };

        this.calculateTotalPrice = this.calculateTotalPrice.bind(this);
        this.getMiscData = this.getMiscData.bind(this);
        ...
        this.getProjectMiscParentItems = this.getProjectMiscParentItems.bind(this);
        this.handleSubmitMisc = this.handleSubmitMisc.bind(this);
    }
    ...
    protected getMiscData(): void {
        new APP.SERVICES.MISC().GetMisc(this.misc_id).then(({data}) => {
    ...
    protected getProjects(): void {
        new APP.SERVICES.MISC().GetProjects().then(({data}) => {
    ...
    protected getSections(): void {
        new APP.SERVICES.MISC().GetSections().then(({data}) => {
    ...
    protected getItemHeads(): void {
        new APP.SERVICES.MISC().GetItemHeads().then(({data}) => {
    ...
    protected getUnits(): void {
        new APP.SERVICES.MISC().GetUnits().then(({data}) => {
    ...
    protected getContractors(): void {
        new APP.SERVICES.MISC().GetContractors().then(({data}) => {
    ...
    protected getSuppliers(): void {
        new APP.SERVICES.MISC().GetSuppliers().then(({data}) => {
    ...
    protected getProjectMiscParentItems(): void {
        new APP.SERVICES.MISC().GetProjectMiscParentItems().then(({data}) => {
    ...
    protected handleSubmitMisc(): void {
        new APP.SERVICES.MISC().SaveMisc({
            fund_id: this.misc_id,
    ...
    public componentDidMount(): void {
        ...
        this.getContractors();
        this.getSuppliers();
        this.getProjectMiscParentItems();
            ...
            <React.Fragment>
                <Card className={__css_card}>
                    <div className={__css_cardTitle}>
                        <div className={"title"}>
                            MISC FUND {this.state.EditMode ? "EDIT" : "CREATE"}
                        ...
                        <Card.Text className={__css_cardText}>
                            <Row>
                                ...
                                <Col md={12} style={{textAlign: "right"}}>
                                    <button className={__css_SaveMiscBtn} onClick={this.handleSubmitMisc}>Submit
                                    </button>
                                </Col>
                            </Row>
                        </Card.Text>
