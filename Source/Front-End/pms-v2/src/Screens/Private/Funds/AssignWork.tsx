...
class AssignWork extends React.Component<any, any> {
    public state: any;
    ...
    public constructor(props: any) {
        ...
        this.handleGetAssignWorks = this.handleGetAssignWorks.bind(this);
    ...
    protected handleGetAssignWorks() {
        new APP.SERVICES.FUND().GetTasks({
            ...
            if (typeof data.data !== 'undefined') {
                ...
                if (typeof responseData.ListData !== 'undefined') {
                    this.setState({
                        AssignWork: responseData.ListData,
                    });
                }
            }
    ...
    protected handleShowDeleteWarning(id: number = 0) {
        ...
        this.setState({
            ...
            new APP.SERVICES.CORE.ALERT_DIALOG().Show({
                ...
                style: {fontSize: 12},
                title: "Are you sure",
                message: "Your Assign Work will be deleted!",
                showCancel: true,
    ...
    public componentDidMount(): void {
        ...
        window.scrollTo(0, 0);
        document.title = "Assign Work List";
    }
        ...
        return (
            <React.Fragment>
                <div style={{marginTop: 15}}>
                    <Row>
                        <Col md={8}>
                            <h4>Assign Work List</h4>
                        </Col>
                        <Col md={4}>
                            <div style={{textAlign: "right"}}>
                                <Link to={APP.ROUTES.PRIVATE.CREATE_ASSIGN_WORK}>
                                    <button className={__css_CreateCFFundBtn}>Create Assign Work</button>
                                </Link>
                            </div>
                        </Col>
                    </Row>

                    <select value={this.state.SelectedFundType}
                            onChange={(e) => {
                            ...
                            onChange={(e) => {
                                this.setState({SelectedProjectId: e.target.value}, () => {
                                    this.setState({
                                        ...
                                        this.getContractors(this.state.SelectedProjectId);
                                    });
                    ...
                    <div style={{background: '#ffffff', padding: 5}}>
                        ...
                        <Table striped bordered hover className={__css_Table} responsive={true} size={"sm"}>
                            ...
                            <tbody>
                            {this.state.AssignWork.map((CFFund: any, index: number) => (
                                <tr key={index}>
                                    <td>{index + 1}</td>
                                    ...
                                    <td>{CFFund.status}</td>
                                    <td>
                                        <Link to={APP.ROUTES.PRIVATE.EDIT_ASSIGN_WORK + '/' + CFFund.id}><FontAwesome
