...
class ContractorForm extends React.Component<any, any> {
    ...
    public constructor(props: any) {
        ...
        this.state = {
            ...
            EditMode: this.contractor_id > 0,
        };

        this.getContractorData = this.getContractorData.bind(this);
        this.getUserRoleList = this.getUserRoleList.bind(this);
        this.getUserTypeList = this.getUserTypeList.bind(this);
        this.handleSubmitContractor = this.handleSubmitContractor.bind(this);
    }

    protected getContractorData(): void {
    ...
    protected getUserRoleList(): void {
        new APP.SERVICES.CONTRACTOR().GetUserRoles().then(({data}) => {
    ...
    protected getUserTypeList(): void {
        new APP.SERVICES.CONTRACTOR().GetUserTypes().then(({data}) => {
    ...
    protected handleSubmitContractor(): void {
        new APP.SERVICES.CONTRACTOR().SaveContractor({
            ...
            <React.Fragment>
                <Card className={__css_card}>
                    <div className={__css_cardTitle}>
                        <div className={"title"}>
                            CONTRACTOR {this.state.EditMode ? "EDIT" : "CREATE"}
                            ...
                            <Row>
                                <Col md={6}>
                                    <TextField defaultValue={""}
                                               ...
                                               name={"contractor_name"} value={this.state.Name}
                                               type={"text"}
                                ...
                                <Col md={6}>
                                    <TextField defaultValue={""}
                                               ...
                                               name={"contractor_email"} value={this.state.Email}
                                               type={"text"}
                                ...
                                <Col md={12} style={{textAlign: "right"}}>
                                    <button className={__css_SaveContractorBtn}
                                            onClick={this.handleSubmitContractor}>Submit
                                    </button>
                                </Col>
                            </Row>
                        </Card.Text>
...
export default withRouter(ContractorForm);